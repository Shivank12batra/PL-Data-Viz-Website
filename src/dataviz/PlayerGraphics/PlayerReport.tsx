  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center text-white m-2">
        <button
          className={`${typeOfStat === "Percentile" && team === "Tottenham" ? "text-black" : null} py-2 px-8 border-2 cursor-pointer transition-colors duration-100`}
          style={{
            borderColor: `${teamColorMapping[team].color}`,
            backgroundColor: `${typeOfStat === "Percentile" ? teamColorMapping[team].color : ""}`,
          }}
        ...
        <button
          className={`${typeOfStat === "Per 90 Mins" && team === "Tottenham" ? "text-black" : null} py-2 px-8 border-2 cursor-pointer transition-colors duration-100`}
          style={{
            borderColor: `${teamColorMapping[team].color}`,
            backgroundColor: `${typeOfStat === "Per 90 Mins" ? teamColorMapping[team].color : ""}`,
          }}
